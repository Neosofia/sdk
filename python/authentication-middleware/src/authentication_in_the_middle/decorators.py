...
def with_authentication(public_key: str, issuer: str, audience: str, algorithms: list[str] | None = None) -> Callable:
    """
    Decorator that validates a Bearer JWT using the provided public key, issuer, and audience.
